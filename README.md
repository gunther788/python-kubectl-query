...
1. Replace all instances of `kubectl_query` with the name of your project
    * These are the Python snake_case references (eg: `kubectl_query`)
1. Replace all instances of `python-kubectl-query` with the name of your project
    * These are the references to your project that will appear in URLs and are typically hyphenated (eg: `project-name`)
1. Replace all instances of `gunther788` with the name of the author or owner of the project
